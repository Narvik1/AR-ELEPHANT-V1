// src/app.js (FINAL - A-Frame hit-test / reticle based)
// Assumes index.html contains:
// - reticle (id="reticle") using aframe-hit-test-component
// - modelRoot (id="modelRoot"), layer_body, layer_skeleton, layer_organs
// - placeModel button (id="placeModel"), controls (id="controls"), placeBtn (id="placeBtn")
// - UI buttons: btnBody, btnSkeleton, btnOrgans, toggleSkeletonSmall
// - data/organs.json exists (optional)
